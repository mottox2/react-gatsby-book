...
type FeedQiitaMetaSortInput = {
  readonly fields: Maybe<ReadonlyArray<Maybe<FeedQiitaMetaFieldsEnum>>>;
  readonly order: Maybe<ReadonlyArray<Maybe<SortOrderEnum>>>;
};

type FeedQiitaSortInput = {
  readonly fields: Maybe<ReadonlyArray<Maybe<FeedQiitaFieldsEnum>>>;
  readonly order: Maybe<ReadonlyArray<Maybe<SortOrderEnum>>>;
};
...
enum FileFieldsEnum {
  ...
  internal___owner = 'internal.owner',
  internal___type = 'internal.type',
  childrenWorksYaml = 'childrenWorksYaml',
  childrenWorksYaml___id = 'childrenWorksYaml.id',
  childrenWorksYaml___parent___id = 'childrenWorksYaml.parent.id',
  childrenWorksYaml___parent___parent___id = 'childrenWorksYaml.parent.parent.id',
  childrenWorksYaml___parent___parent___children = 'childrenWorksYaml.parent.parent.children',
  childrenWorksYaml___parent___children = 'childrenWorksYaml.parent.children',
  childrenWorksYaml___parent___children___id = 'childrenWorksYaml.parent.children.id',
  childrenWorksYaml___parent___children___children = 'childrenWorksYaml.parent.children.children',
  childrenWorksYaml___parent___internal___content = 'childrenWorksYaml.parent.internal.content',
  childrenWorksYaml___parent___internal___contentDigest = 'childrenWorksYaml.parent.internal.contentDigest',
  childrenWorksYaml___parent___internal___description = 'childrenWorksYaml.parent.internal.description',
  childrenWorksYaml___parent___internal___fieldOwners = 'childrenWorksYaml.parent.internal.fieldOwners',
  childrenWorksYaml___parent___internal___ignoreType = 'childrenWorksYaml.parent.internal.ignoreType',
  childrenWorksYaml___parent___internal___mediaType = 'childrenWorksYaml.parent.internal.mediaType',
  childrenWorksYaml___parent___internal___owner = 'childrenWorksYaml.parent.internal.owner',
  childrenWorksYaml___parent___internal___type = 'childrenWorksYaml.parent.internal.type',
  childrenWorksYaml___children = 'childrenWorksYaml.children',
  childrenWorksYaml___children___id = 'childrenWorksYaml.children.id',
  childrenWorksYaml___children___parent___id = 'childrenWorksYaml.children.parent.id',
  childrenWorksYaml___children___parent___children = 'childrenWorksYaml.children.parent.children',
  childrenWorksYaml___children___children = 'childrenWorksYaml.children.children',
  childrenWorksYaml___children___children___id = 'childrenWorksYaml.children.children.id',
  childrenWorksYaml___children___children___children = 'childrenWorksYaml.children.children.children',
  childrenWorksYaml___children___internal___content = 'childrenWorksYaml.children.internal.content',
  childrenWorksYaml___children___internal___contentDigest = 'childrenWorksYaml.children.internal.contentDigest',
  childrenWorksYaml___children___internal___description = 'childrenWorksYaml.children.internal.description',
  childrenWorksYaml___children___internal___fieldOwners = 'childrenWorksYaml.children.internal.fieldOwners',
  childrenWorksYaml___children___internal___ignoreType = 'childrenWorksYaml.children.internal.ignoreType',
  childrenWorksYaml___children___internal___mediaType = 'childrenWorksYaml.children.internal.mediaType',
  childrenWorksYaml___children___internal___owner = 'childrenWorksYaml.children.internal.owner',
  childrenWorksYaml___children___internal___type = 'childrenWorksYaml.children.internal.type',
  childrenWorksYaml___internal___content = 'childrenWorksYaml.internal.content',
  childrenWorksYaml___internal___contentDigest = 'childrenWorksYaml.internal.contentDigest',
  childrenWorksYaml___internal___description = 'childrenWorksYaml.internal.description',
  childrenWorksYaml___internal___fieldOwners = 'childrenWorksYaml.internal.fieldOwners',
  childrenWorksYaml___internal___ignoreType = 'childrenWorksYaml.internal.ignoreType',
  childrenWorksYaml___internal___mediaType = 'childrenWorksYaml.internal.mediaType',
  childrenWorksYaml___internal___owner = 'childrenWorksYaml.internal.owner',
  childrenWorksYaml___internal___type = 'childrenWorksYaml.internal.type',
  childrenWorksYaml___slug = 'childrenWorksYaml.slug',
  childrenWorksYaml___title = 'childrenWorksYaml.title',
  childrenWorksYaml___imageUrl = 'childrenWorksYaml.imageUrl',
  childrenWorksYaml___roles = 'childrenWorksYaml.roles',
  childrenWorksYaml___description = 'childrenWorksYaml.description',
  childrenWorksYaml___gatsbyPath = 'childrenWorksYaml.gatsbyPath'
}
...
type Query_allFeedQiitaMetaArgs = {
  filter: Maybe<FeedQiitaMetaFilterInput>;
  sort: Maybe<FeedQiitaMetaSortInput>;
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
};
...
type Query_allFeedQiitaArgs = {
  filter: Maybe<FeedQiitaFilterInput>;
  sort: Maybe<FeedQiitaSortInput>;
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
};
...
type WorkDetailQuery = { readonly worksYaml: Maybe<Pick<WorksYaml, 'slug' | 'title' | 'description' | 'imageUrl' | 'roles'>> };

type IndexPageQueryVariables = Exact<{ [key: string]: never; }>;


type IndexPageQuery = { readonly allFeedQiita: { readonly nodes: ReadonlyArray<Pick<FeedQiita, 'title' | 'link' | 'pubDate'>> }, readonly allWorksYaml: { readonly nodes: ReadonlyArray<Pick<WorksYaml, 'slug' | 'title' | 'description' | 'imageUrl' | 'roles'>> } };
